...
class WasteTransferNote(models.Model):
    ...
    r_waste_tracking_note_code = models.TextField(db_column='r_waste_tracking_note_code',max_length=300, null=True, blank=True)
    r_waste_transfer_note_date = models.TextField(db_column='r_waste_transfer_note_date',max_length=300, null=True, blank=True)
    r_waste_transferor_name = models.TextField(db_column='r_waste_transferor_name',max_length=300, null=True, blank=True)
    r_waste_transferor_postcode = models.TextField(db_column='r_waste_transferor_postcode',max_length=300, null=True, blank=True)
    r_ewc_code = models.TextField(db_column='r_ewc_code',max_length=300, null=True, blank=True)
    r_sic_code = models.TextField(db_column='r_sic_code',max_length=300, null=True, blank=True)
    r_waste_quantity = models.TextField(db_column='r_waste_quantity',max_length=300, null=True, blank=True)
    r_waste_destination_name = models.TextField(db_column='r_waste_destination_name',max_length=300, null=True, blank=True)
    r_waste_destination_address = models.TextField(db_column='r_waste_destination_address',max_length=300, null=True, blank=True)
    r_waste_destination_postcode = models.TextField(db_column='r_waste_destination_postcode',max_length=300, null=True, blank=True)
    r_destination_permit_no = models.TextField(db_column='r_destination_permit_no',max_length=300, null=True, blank=True)
    r_destination_exemption_no = models.TextField(db_column='r_destination_exemption_no',max_length=300, null=True, blank=True)
    r_waste_carrier_name = models.TextField(db_column='r_waste_carrier_name',max_length=300, null=True, blank=True)
    r_waste_carrier_address = models.TextField(db_column='r_waste_carrier_address',max_length=300, null=True, blank=True)
    r_waste_carrier_postcode = models.TextField(db_column='r_waste_carrier_postcode',max_length=300, null=True, blank=True)
    r_waste_carrier_license_no = models.TextField(db_column='r_waste_carrier_license_no',max_length=300, null=True, blank=True)
    r_container_size = models.TextField(db_column='r_container_size',max_length=300, null=True, blank=True)
    r_number_of_containers = models.TextField(db_column='r_number_of_containers',max_length=300, null=True, blank=True)
    modified_date = models.DateTimeField(db_column='modified_date',max_length=300, null=True, blank=True)
    modified_by = models.TextField(db_column='modified_by',max_length=300, null=True, blank=True)
    r_waste_transferor_address = models.TextField(db_column='r_waste_transferor_address',max_length=300, null=True, blank=True)
...
class WasterTransferNoteChangeLog(models.Model):
    waste_transfer_note_data_id = models.BigIntegerField(db_column='waste_transfer_note_data_id', null=True, blank=True)
    waste_tracking_note_code = models.TextField(db_column='waste_tracking_note_code',max_length=300, null=True, blank=True)
    waste_transfer_note_date = models.TextField(db_column='waste_transfer_note_date',max_length=300, null=True, blank=True)
    waste_transferor_name = models.TextField(db_column='waste_transferor_name',max_length=300, null=True, blank=True)
    waste_transferor_address = models.TextField(db_column='waste_transferor_address',max_length=300, null=True, blank=True)
    waste_transferor_postcode = models.TextField(db_column='waste_transferor_postcode',max_length=300, null=True, blank=True)
    ...
    building_id =  models.BigIntegerField(db_column='building_id', null=True, blank=True)
    customer_ref = models.TextField(db_column='customer_ref',max_length=300, null=True, blank=True)
    waste_disposal_code = models.BigIntegerField(db_column='waste_disposal_code', null=True, blank=True)
    waste_phase_code = models.BigIntegerField(db_column='waste_phase_code', null=True, blank=True)
    r_waste_tracking_note_code = models.TextField(db_column='r_waste_tracking_note_code',max_length=300, null=True, blank=True)
    r_waste_transfer_note_date =models.TextField(db_column='r_waste_transfer_note_date',max_length=300, null=True, blank=True)
    r_waste_transferor_name = models.TextField(db_column='r_waste_transferor_name',max_length=300, null=True, blank=True)
    r_waste_transferor_address = models.TextField(db_column='r_waste_transferor_address',max_length=300, null=True, blank=True)
    ...
    r_container_size = models.TextField(db_column='r_container_size',max_length=300, null=True, blank=True)
    r_number_of_containers = models.TextField(db_column='r_number_of_containers',max_length=300, null=True, blank=True)
    r_waste_disposal_code = models.BigIntegerField(db_column='r_waste_disposal_code', null=True, blank=True)
    r_waste_phase_code = models.BigIntegerField(db_column='r_waste_phase_code', null=True, blank=True)
    revised_date =  models.DateTimeField(db_column='revised_date', null=True, blank=True)
    revised_by = models.TextField(db_column='revised_by',max_length=300, null=True, blank=True)
    waste_carrier_license_issue_date = models.DateField(db_column='waste_carrier_license_issue_date',max_length=300, null=True, blank=True)
    waste_carrier_license_expiry_date = models.DateField(db_column='waste_carrier_license_expiry_date',max_length=300, null=True, blank=True)
    destination_permit_issue_date = models.DateField(db_column='destination_permit_issue_date',max_length=300, null=True, blank=True)
    destination_permit_status = models.TextField(db_column='destination_permit_status',max_length=300, null=True, blank=True)
    destination_exemption_issue_date = models.DateField(db_column='destination_exemption_issue_date',max_length=300, null=True, blank=True)
    destination_exemption_expiry_date = models.DateField(db_column='destination_exemption_expiry_date',max_length=300, null=True, blank=True)
    
    class Meta:
        managed = False
        db_table = 'waste_transfer_note_change_log'
