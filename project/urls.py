...
urlpatterns = [
    ...
    #################################### App Delivery Note or Best Match ######################################################
    ...
    ################################### Toufiq ###########################################################
    path('api/getcount/',getCount.as_view()),
    path('api/get_options/', GetOptionsAPI.as_view()),
    path('api/get_document_data/', Get_App_Deleivery_Note_API.as_view()),
    path('api/get_buildings_user/', Get_Building_User_API.as_view()),
    path('api/phases/', Get_Phases_API.as_view()),
    path('api/unitofmeasure/', Get_UnitofMeasure_API.as_view()),
    path('api/UpdateDeliveryNoteAPI/',UpdateDeliveryNoteAPI.as_view()),
    path('api/product-mapping/', ProductMappingListAPI.as_view(), name='product-mapping-list'),
    path('api/deliverynoteref/', DeliveryNoteListByCustomerRefAPI.as_view(), name='DeliveryNoteListByCustomerRefAPI'),
    path('api/deliverynotelistBydeliverynoterefno/', DeliveryNoteListByDeliveryNoteRefNoAPI.as_view(), name='DeliveryNoteListByDeliveryNoteRefNoAPI'),
    path('api/delivery_notes_by_user/',DeliveryNoteListByUserAPI.as_view(),name="DeliveryNoteListByUserAPI"),
    path('api/assign_unique_number/', AssignUniqueNumberAPI.as_view(), name='assign-unique-number'),
    path('api/get_file_name/', GetFileNameAPI.as_view(), name='get-file-name'),

    ################################# Waste Transfer Note ###########################################################
    path('api/waste-transfer-note/', WasteTransferNoteAPIView.as_view()),
    path('api/waste-transfer-note/<int:id>/', WasteTransferNoteAPIView.as_view()),
    ...
    path('api/waste-disposal/<int:id>/', WasteDisposalAPIView.as_view()),
